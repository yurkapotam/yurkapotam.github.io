...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
            ...
            <head>
                <style>
                    ...
                    g:before {
                        ...
                        top: 10px;
                        left: 10px;
                        width: calc(<xsl:value-of select="puzzle/size"></xsl:value-of>*var(--s)*0.6);
                        aspect-ratio: 1;
                    ...
                    z:nth-child(-n + calc(<xsl:value-of select="puzzle/size"></xsl:value-of> - 1)):not(:first-child) b
                    {
                    ...
                    z:nth-child(<xsl:value-of select="puzzle/size"></xsl:value-of>) b
                    {
                        place-self: start end;
                        height: calc(100% + var(--r));
                        width: calc(100% + var(--r));
                    ...
                    z:nth-child(<xsl:value-of select="puzzle/size"></xsl:value-of>n + 1):not(:first-child):not(:nth-last-child(<xsl:value-of select="puzzle/size"></xsl:value-of>)) b
                    {
                        height: calc(100% + var(--r));
                        width: 100%;
                        --m: 
                    ...
                    z:nth-last-child(<xsl:value-of select="puzzle/size"></xsl:value-of>) b
                    {
                        height: 100%;
                        width: 100%;
                        --m: 
                    ...
                    z:nth-child(<xsl:value-of select="puzzle/size"></xsl:value-of>n):not(:nth-child(<xsl:value-of select="puzzle/size"></xsl:value-of>)):not(:last-child) b
                    {
                        place-self: start end;
                        height: calc(100% + var(--r));
                        width: calc(100% + var(--r));
                    ...
                    z:nth-last-child(-n + calc(<xsl:value-of select="puzzle/size"></xsl:value-of> - 1)):not(:last-child) b
                    {
                        place-self: end;
                        height: 100%;
                        width: calc(100% + var(--r));
                    ...
                    {
                        content: "";
                        background: var(--i) 0/calc(<xsl:value-of select="puzzle/size"></xsl:value-of>*var(--s)) calc(<xsl:value-of select="puzzle/size"></xsl:value-of>*var(--s));
                        -webkit-mask: var(--m);
                        mask: var(--m);
                    }
                    ...
                    <xsl:call-template name="generate_style">
                        <xsl:with-param name="x"><xsl:value-of select="puzzle/size * puzzle/size"></xsl:value-of></xsl:with-param>
                    </xsl:call-template>
                </style>
            </head>
            <body>
    ...
    <xsl:template name="generate_style">
        <xsl:param name="x" />
        z:nth-of-type(<xsl:value-of select="$x"></xsl:value-of>) b
        {
            transform: translate(calc(calc(<xsl:value-of select="puzzle/size"></xsl:value-of> - 1) / 2 - <xsl:value-of select="($x - 1) mod puzzle/size"></xsl:value-of>) * 100%,calc(calc(<xsl:value-of select="puzzle/size"></xsl:value-of> - 1) / 2 - <xsl:value-of select="floor(($x - 0.001) div puzzle/size)"></xsl:value-of>) * 100%) rotate(calc(152 * 1deg)) translate(calc(30 * 1% + calc(<xsl:value-of select="puzzle/size"></xsl:value-of> - 1) * 100%)) rotate(calc(calc(15 - 10 - 88) * 1deg));
        }

        z:nth-of-type(<xsl:value-of select="$x"></xsl:value-of>) b:before
        {
            background-position: calc(calc(<xsl:value-of select="($x - 1) mod puzzle/size"></xsl:value-of> / calc(<xsl:value-of select="puzzle/size"></xsl:value-of> - 1)) * 100%) calc(calc(<xsl:value-of select="floor(($x - 0.001) div puzzle/size)"></xsl:value-of> / calc(<xsl:value-of select="puzzle/size"></xsl:value-of> - 1)) * 100%);
        }
        <xsl:if test="$x > 0">
